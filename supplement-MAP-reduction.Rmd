...
We manually coded these estimates as 0.01, a convention borrowed from @porat2024. If we set these to be equal to 0.00 instead, our meta-analytic estimate remains `r zero_delta`.
