...
Our dataset featured heterogeneous outcomes and sample variances, which makes it difficult to suggest either a rules of thumb or common-sense interpretations of effect sizes [@mastrich2021] that apply broadly.
However, for context, our largest effect size [@carfora2023] recorded self-reported servings of red, processed, and white meat over the previous week.
