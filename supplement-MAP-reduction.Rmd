...
Our code and data are shared on GitHub (https://github.com/hsflabstanford/vegan-meta), and Code Ocean (https://doi.org/10.24433/CO.6020578.v5). The Code Ocean repository allows for reproducing our papers' results without downloading any files or managing software versions.
