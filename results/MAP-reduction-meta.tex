...
forms of MAP. Incorporating a set of marginal studies that do not quite
meet our inclusion criteria inflates the pooled effect size to SMD = 0.2
(95\% CI: {[}0.09. 0.31{]}). We conclude that while no theoretical
...
\begin{center}\includegraphics[width=1.2\linewidth,]{./prisma-diagram} \end{center}
