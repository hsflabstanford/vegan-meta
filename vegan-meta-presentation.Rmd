...
Descriptive: "The results of last week show that the average meat consumption of Dutch residents was: 1.32 times per day...Based on your answers, it appears that your meat consumption is above-average compared to the average Dutch resident" [@alblas2023]
...
The lines between perspectives are tricky – is a norm a nudge if it's a cafeteria? Is a message saying that your peers think that a veggie burger is tasty communicating "normative" information?
...
But if you read the literature, you might find & propose different boundaries
...
Previous meta-analyses have found much larger effects, e.g. @mathur2021meta, which meta-analyzed "100 studies assessing interventions designed to reduce meat consumption or purchase by mentioning or portraying farm animals" and found "meaningfully large effects (meta- analytic mean risk ratio [RR] = 1.22; 95% CI: [1.13, 1.33])."

This difference is overdetermined but most of it probably comes from our focus on MAP consumption (vs. attitudes & intentions)
