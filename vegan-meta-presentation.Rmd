...
![](tables/country_breakdown_table.png){width="392"}
...
![](tables/all_results_gt_table.png)

## Results by delivery method

![](tables/delivery_method_table.png)

## How do materials from advocacy organizations do?

![](tables/advocacy_org_table.png){width="687"}

## What about country?

![](tables/country_results_table.png){width="522"}

## Population?

![](tables/population_results_table.png)

## Good news on the open science front

![](tables/study_quality_results_table.png)
