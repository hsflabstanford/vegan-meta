...
\begin{column}{0.4\textwidth}
\centering
\includegraphics[width=\textwidth]{./images/norms.png}
\end{column}
\begin{column}{0.4\textwidth}
...
\note{-   "News from [Name of Restaurant]! We’ve noticed that customers are starting to eat less meat by choosing more meatless dishes" [@sparkman2020]}
\end{column}
\end{columns}
