...
We observe consistently small effects across categories of population (all SMDs < 0.1), but more heterogeneity by region: North America, where a majority of studies took place, had an average effect of SMD = `r NA_delta` vs. a range of 0.14 to 0.21 for other locations. \begin{comment} I don't like this sentence, but I am not sure what else so I am just moving on \end{comment}
