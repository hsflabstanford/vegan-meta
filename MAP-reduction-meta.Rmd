...
-   `review-of-reviews.csv`, which details on the the `r reviews_count` reviews we consulted;
...
Using our original cluster-robust estimation strategy from `metafor`, we detect a pooled effect size of `r round(alt_model$beta, 2)` (95% CI: [`r paste0(round(alt_model$ci.lb, 2), ", ", round(alt_model$ci.ub, 2))`]), p = `r alt_model$pval`.
