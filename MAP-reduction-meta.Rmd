...
[INTRODUCTORY REMARKS ABOUT HOW PUBLICATION BIAS PUTS THE MAIN RESULT IN ONE LIGHT OR ANOTHER?]
...
Second, the `r pap_model$N_studies` studies with a pre-analysis plan have a smaller overall effect: $\Delta$ = `r pap_model$Delta` (SE = `r pap_model$se`), p = `r pap_model$pval`.
This difference is not statistically significant.
