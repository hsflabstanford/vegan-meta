...
knitr::include_graphics('./prisma-diagram.png')
...
For example, many outcome measures in our database quite coarse, such as self-reports of whether participants ate more or less MAP, without further quantification, in the week after treatment than in a typical week [@aberman2018] or simply after treatment than before [@cooney2016].
