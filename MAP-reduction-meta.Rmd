...
As a roustness check, we also coded and meta-analyzed a supplementary dataset of `r robust_only_results$N_studies` marginal studies, comprising `r robust_only_results$N_estimates` point estimates.
One of these studies met our inclusion criteria but required some guesswork in extracting an effect size; the others were strong designs that met all but one of our inclusion criteria, e.g. the control group received some aspect of treatment [@piazza2022], or treatment was alternated weekly but not randomly [@garnett2020] (Supplement).
