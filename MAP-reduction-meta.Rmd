...
We also coded a supplementary dataset of `r RPMC_papers` aimed at reducing consumption of red and/or processed meat (RPM), comprising `r RPMC_studies` studies and `r RPMC_interventions` interventions.
This was to provide a comparison between studies that aimed to reduce overall MAP consumption and those that only measured RPM reductions without reporting on potential substitution to other MAP products.
