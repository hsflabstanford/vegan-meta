...
We observe consistently small effects across categories of population (all SMDs < 0.1), but more variance by region: North America, where a majority of studies took place, had an average effect of SMD = `r region_results |> filter(Moderator == "North America") |> pull(Delta)` vs. 
