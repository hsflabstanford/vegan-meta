...
* N of treatment and N of control are from post-test rather than pre-test.
...
Anything else we do is exploratory based on trends we observe in the data once we actually do the analysis.
