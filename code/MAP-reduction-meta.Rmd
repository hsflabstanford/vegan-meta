...
Last, when we incorporate MAP reduction studies that some but not all of our methodological criteria, we find a substantially larger overall effect.
...
We also coded and meta-analyzed a supplementary dataset of `r robust_only_results$N_studies` studies, comprising `r robust_only_results$N_estimates` point estimates, that typically fell short on one of our inclusion criteria, e.g. where the control group receives some aspect of treatment [@piazza2022], or where treatment was alternated weekly but not randomly [@garnett2020] (Supplement), but otherwise featured strong designs and rigorous measurement strategies []

integrating these studies into our primary dataset yields a pooled effect of SMD = `r merged_results$Delta` (95% CI: `r merged_results$CI`), p = `r merged_results$p_val`.
