...
well-regarded strand of this literature employs choice architecture,
...
that placed fewer (if any) restrictions on studies' methodological
rigor, we conclude that meaningfully reducing MAP consumption is an
unsolved problem. However, many promising approaches still await
rigorous evaluation.
...
subjects(25\(^{\text{th}}\)-75\(^{\text{th}}\) percentiles: 109, 208).
