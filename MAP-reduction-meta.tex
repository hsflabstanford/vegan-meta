...
somewhat larger among the choice architecture studies (SMD = ), but the
sample size was much smaller (3 estimates). Within studies with a
...
to animal welfare (SMD = 0.03, 16 studies with 65 estimates).
