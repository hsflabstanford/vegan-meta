...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{choice\_results }\OtherTok{\textless{}{-}}\NormalTok{ dat }\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(theory }\SpecialCharTok{==} \StringTok{\textquotesingle{}Choice Architecture\textquotesingle{}}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \FunctionTok{extract\_model\_results}\NormalTok{() }

\NormalTok{persuasion\_results }\OtherTok{\textless{}{-}}\NormalTok{ dat }\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(theory }\SpecialCharTok{==} \StringTok{\textquotesingle{}Persuasion\textquotesingle{}}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \FunctionTok{extract\_model\_results}\NormalTok{() }

\NormalTok{psych\_results }\OtherTok{\textless{}{-}}\NormalTok{ dat }\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(theory }\SpecialCharTok{==} \StringTok{\textquotesingle{}Psychology\textquotesingle{}}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \FunctionTok{extract\_model\_results}\NormalTok{()}

\NormalTok{psych\_persuasion\_results }\OtherTok{\textless{}{-}}\NormalTok{ dat }\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(theory }\SpecialCharTok{==} \StringTok{\textquotesingle{}Persuasion \& Psychology\textquotesingle{}}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \FunctionTok{extract\_model\_results}\NormalTok{() }
\end{Highlighting}
\end{Shaded}
...
as the three categories of persuasion (animal welfare, environment, and
health).
