...
##  1 Peacock    2017 -0.538 0.213           -1     -0.955     -0.120  
##  2 Polanco    2022  0.356 0.174            0      0.0153     0.697  
##  3 Polanco    2022 -0.356 0.177            0     -0.702     -0.0101 
##  4 Piester    2020  0.509 0.189            1      0.139      0.880  
##  5 Mattson    2020 -0.380 0.190            0     -0.754     -0.00712
##  6 Merrill    2009  0.707 0.196            1      0.323      1.09   
##  7 Bertolaso  2015  0.293 0.137            0      0.0249     0.560  
##  8 Carfora    2023  0.819 0.231            0      0.366      1.27   
##  9 Carfora    2023  0.810 0.233            0      0.353      1.27   
## 10 Carfora    2023  0.530 0.220            0      0.0983     0.962  
## 11 Carfora    2023  0.513 0.228            1      0.0663     0.960  
## 12 Sparkman   2017  0.319 0.141            1      0.0433     0.595  
## 13 Bianchi    2022  0.529 0.190            1      0.156      0.901
\end{verbatim}

This small effect may come as a surprise to readers of previous reviews,
which found more positive results \citep{mathur2021meta, chang2023}. We
attribute this difference to our inclusion criteria. For instance, of
the ten largest effect sizes recorded in
\citep{mathur2021effectiveness}, nine were non-consumption outcomes and
the tenth came from a non-randomized design.
(\citep{bianchi2018conscious} also found effects on intentions and
attitudes but no evidence of effects on behavior.)

According to their papers, 95 of 107 interventions had null effects.
However, many studies present a variety of wide variety of outcomes and
lead with, e.g., a gender-moderated effect \citep{piester2020} or the
relationship between an underlying attitude measure and consumption
outcomes \citep{Berndsen2005}, or where meat reduction was just one of
many strategies suggested as part of a broader program
\citep{abramahse2007}.

\begin{itemize}
\tightlist
\item
  This section depends on what model we choose - note the preponderance
  of nulls according to the studies themselves - some weak evidence of
  publication bias (effect size goes up as SE gets bigger)
\end{itemize}
