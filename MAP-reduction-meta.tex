...
\bottomrule
\multicolumn{4}{l}{\textsuperscript{} Note that because many studies present more than one category of message, the number of}\\
\multicolumn{4}{l}{studies and interventions will sum to more than the total number of persuasion studies and}\\
\multicolumn{4}{l}{interventions.}\\
\end{tabular}
\end{table}
...
\includegraphics{results/forest_plot_nulls_and_CIs-1}
...
\midrule
Printed Materials & 56 & 12 & 0.0134 (0.0304)\\
In-Cafeteria & 18 & 10 & 0.0648 (0.0388)\\
Video & 16 & 10 & 0.0124 (0.0166)\\
Online & 9 & 4 & 0.0660 (0.0246)\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
North America & 70 & 21 & 0.0477 (0.0251)\\
Europe & 27 & 13 & 0.1030 (0.0507)\\
Asia, Australia, and worldwide & 10 & 5 & 0.0002 (0.0716)\\
\bottomrule
\end{tabular}
\end{table}
...
Second, we applaud researchers and advocates in this field for
publicizing null results when they find them. Third, we notice that the
universe of possible interventions is much broader than those we
analyzed, suggesting that some promising approaches have yet to be
rigorously evaluated (e.g.~direct contact with animals on an animal
sanctuary, price gradations, high-intensity vegan meal planning, or
door-to-door canvassing). We also note that many viable study sites are
absent from our database, e.g.~retirement homes, and we encourage
researchers to search more broadly for potential subjects.
