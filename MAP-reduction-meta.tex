...
\begin{center}\includegraphics{./figures/funnel_plot-1} \end{center}

\begin{center}\includegraphics[width=1\linewidth,]{./figures/prisma-diagram} \end{center}
...
analysis to the 31 studies and 96 point estimates where this secondary
delay exceeds zero, we observe an effect of SMD = 0.07 (95\% CI:
{[}0.01, 0.12{]}), p = .0283.
