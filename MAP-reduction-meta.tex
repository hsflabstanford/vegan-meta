...
\subsection{An overall small effect and evidence of publication
bias}\label{sec2.2}
...
The 9 with a pre-analysis plan have a smaller overall effect: \(\Delta\)
= 0.0394 (SE = 0.022), p = .1505. This difference is not statistically
significant. The The 12 with openly available data also have a smaller
overall effect: \(\Delta\) = 0.0268 (SE = 0.0315), p = .4357. This
difference is also not statistically significant.

Last, the pooled effect size of interventions published in peer-reviewed
journals is about 9 times larger than the equivalent effect size in
student theses (see table 3). Interventions published by advocacy
organizations produce a small backlash effect on average.
...
\(\Delta\) = 0.2493 \text{(SE = 0.0707)}, p = .0045. Each of these
...
\subsection{Animal welfare appeals are mostly
ineffective}\label{animal-welfare-appeals-are-mostly-ineffective}
