...
that its veggie burgers are "on the rise" [@sparkman2020], perhaps that
triggers a "herd mentality" [@mols2015, p. 3], but perhaps the patron
thinks of their vegetarian friends, the environment, or animal welfare
and makes a socially conscious choice. We do not know and do not assume
that people react unthinkingly. Therefore, we do not classify the norms
...
time (see @bicchieri2023 for discussion).
