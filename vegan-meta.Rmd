...
(Does this go in the appendix? What is actually necessary for readers?)
...
dat |> 
  mutate(theory_category = if_else(str_detect(theory, "&"), "hybrid", theory),
         study_name = factor(reorder(paste(author, year), desc(se_d)), 
                             levels = 
                               c(levels(factor(paste(author, year))), 
                                 "Overall Estimate"))) |> 
  gg_meta_plot(theory_category)
```
