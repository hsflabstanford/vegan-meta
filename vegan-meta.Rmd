...
```{r red_meat_supplementary_analysis, echo=F, include=F}
red_meat <- read.csv("./data/supplementary-red-and-processed-meat-data.csv") |>
  group_by(title) |>
  mutate(unique_paper_id = cur_group_id())  |> 
  ungroup() |> 
  group_by(unique_paper_id, intervention_condition) |> 
