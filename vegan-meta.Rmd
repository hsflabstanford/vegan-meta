...
A majority of studies (`r country_dat["United States"]` of `r num_studies`) take place exclusively in the United States. with a further `r country_dat["Italy"]` in Italy and `r country_dat["United Kingdom"]` in the United Kingdom. Sweden, the Netherlands, Denmark, Canada, and Australia had one study apiece, and one internet-based study had participants in the United States, United Kingdom, Canada, Australia, and 'other'
