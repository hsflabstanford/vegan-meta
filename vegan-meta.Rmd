...
Finally, `r nrow(hybrid_norm_approaches)` deploy norms-based nudges in unobtrusive ways in dining halls [@piester2020, @coker2022], which arguably makes them nudges (see )  For example, @piester2020 combined a descriptive norm message with a nudge: a sign that said "In a taste test we did at the [name of cafe], 95% of people said that the veggie burger tasted good or very good!" [@piester2020, p. 5]. @coker2022 combined a descriptive norm message with a nudge: a sign that said “[More and more [retail store name] customers are choosing our veggie options" [@coker2022, p. 2].
