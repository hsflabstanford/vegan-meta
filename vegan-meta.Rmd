...
Finally, we conducted a systematic search of Google Scholar for the terms [OUR SEARCH TERMS ONCE WE ARE DONE]. This yielded `r systematic_search_papers` more paper, bringing our total sample size to `r num_papers` papers and `r num_studies` interventions.[^3]
...
```{r descriptive_stats, echo = F, eval = F}
library(dplyr)
library(stringr)
library(purrr)
source("./code/functions/sum_tab.R")
