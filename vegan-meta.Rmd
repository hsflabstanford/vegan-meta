...
Table XXX presents the results of our meta-analysis by theoretical approach. Note that because many studies present overlapping approaches, 

Nudges are generally the  The smallest effect sizes come from interventions that appeal to animal welfare. Nudges and norms-based interventions produce similar effect sizes, while persuasion interventions produce the smallest effect sizes.
...
#### Norms results in more detail
dynamic_norms_results <- dat |> filter(str_detect(brief_description, "dynamic")) |> count_and_robust(); 
