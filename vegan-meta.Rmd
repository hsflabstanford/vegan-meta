...
These four categories of publication -- preprint, jounral article, theses (both bachelor's and graduate), and advocacy organization materials -- are subject to different processes and incentives. One way to account for this in a check for publication bias is to look for a relationship between standard errors and effect sizes within journal articles, which would be evidence for the "file drawer problem" [@rosenthal1979file]. We find no such relationship (b = `r within_journal_article_bias[2,1]` (se = `r within_journal_article_bias[2,2]`), p = `r within_journal_article_bias[2,4]`). 
...
|-----------------|----------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| General     | `r advocacy_results$'FALSE'['N_unique']`                 | `r advocacy_results$'FALSE'['Delta']` (`r advocacy_results$'FALSE'['se']`)`r ifelse(advocacy_results$'FALSE'['pval'] < 0.05, "*", ifelse(advocacy_results$'FALSE'['pval'] < 0.01, "**", ifelse(advocacy_results$'FALSE'['pval'] < 0.001, "***", "")))` |
| Advocacy organization   | `r advocacy_results$'TRUE'['N_unique']`                  | `r advocacy_results$'TRUE'['Delta']` (`r advocacy_results$'TRUE'['se']`)`r ifelse(advocacy_results$'TRUE'['pval'] < 0.05, "*", ifelse(advocacy_results$'TRUE'['pval'] < 0.01, "**", ifelse(advocacy_results$'TRUE'['pval'] < 0.001, "***", "")))`   |
