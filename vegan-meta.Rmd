...
| Organization        | N (studies)                               | Delta (se)                                                                                                           |
|---------------------|-------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
| Animal Rights Watch | `r advocacy_org_specific_results$'Animal Rights Watch'[['N_unique']]` | `r advocacy_org_specific_results$'Animal Rights Watch'[['Delta']]` (`r advocacy_org_specific_results$'Animal Rights Watch'[['se']]`)**`r ifelse(advocacy_org_specific_results$'Animal Rights Watch'[['pval']] < 0.05, "*", ifelse(advocacy_org_specific_results$'Animal Rights Watch'[['pval']] < 0.01, "**", ifelse(advocacy_org_specific_results$'Animal Rights Watch'[['pval']] < 0.001, "***", "")))` |
| Animals Australia   | `r advocacy_org_specific_results$'Animals Australia'[['N_unique']]`   | `r advocacy_org_specific_results$'Animals Australia'[['Delta']]` (`r advocacy_org_specific_results$'Animals Australia'[['se']]`)**`r ifelse(advocacy_org_specific_results$'Animals Australia'[['pval']] < 0.05, "*", ifelse(advocacy_org_specific_results$'Animals Australia'[['pval']] < 0.01, "**", ifelse(advocacy_org_specific_results$'Animals Australia'[['pval']] < 0.001, "***", "")))` |
| Faunalytics        | `r advocacy_org_specific_results$Faunalytics[['N_unique']]`            | `r advocacy_org_specific_results$Faunalytics[['Delta']]` (`r advocacy_org_specific_results$Faunalytics[['se']]`)**`r ifelse(advocacy_org_specific_results$Faunalytics[['pval']] < 0.05, "*", ifelse(advocacy_org_specific_results$Faunalytics[['pval']] < 0.01, "**", ifelse(advocacy_org_specific_results$Faunalytics[['pval']] < 0.001, "***", "")))` |
| Humane League       | `r advocacy_org_specific_results$'Humane League'[['N_unique']]`       | `r advocacy_org_specific_results$'Humane League'[['Delta']]` (`r advocacy_org_specific_results$'Humane League'[['se']]`)**`r ifelse(advocacy_org_specific_results$'Humane League'[['pval']] < 0.05, "*", ifelse(advocacy_org_specific_results$'Humane League'[['pval']] < 0.01, "**", ifelse(advocacy_org_specific_results$'Humane League'[['pval']] < 0.001, "***", "")))` |
| Mercy For Animals   | `r advocacy_org_specific_results$'Mercy For Animals'[['N_unique']]`   | `r advocacy_org_specific_results$'Mercy For Animals'[['Delta']]` (`r advocacy_org_specific_results$'Mercy For Animals'[['se']]`)**`r ifelse(advocacy_org_specific_results$'Mercy For Animals'[['pval']] < 0.05, "*", ifelse(advocacy_org_specific_results$'Mercy For Animals'[['pval']] < 0.01, "**", ifelse(advocacy_org_specific_results$'Mercy For Animals'[['pval']] < 0.001, "***", "")))` |
| NA (academic)       | `r advocacy_org_specific_results$N[['N_unique']]`                    | `r advocacy_org_specific_results$N[['Delta']]` (`r advocacy_org_specific_results$N[['se']]`)**`r ifelse(advocacy_org_specific_results$N[['pval']] < 0.05, "*", ifelse(advocacy_org_specific_results$N[['pval']] < 0.01, "**", ifelse(advocacy_org_specific_results$N[['pval']] < 0.001, "***", "")))` |
| Vegan Outreach      | `r advocacy_org_specific_results$'Vegan Outreach'[['N_unique']]`     | `r advocacy_org_specific_results$'Vegan Outreach'[['Delta']]` (`r advocacy_org_specific_results$'Vegan Outreach'[['se']]`)**`r ifelse(advocacy_org_specific_results$'Vegan Outreach'[['pval']] < 0.05, "*", ifelse(advocacy_org_specific_results$'Vegan Outreach'[['pval']] < 0.01, "**", ifelse(advocacy_org_specific_results$'Vegan Outreach'[['pval']] < 0.001, "***", "")))` |

[table XXX about here]

On the one hand, we applaud these organizations for making their materials freely available and for publishing null results when they find them. On the other, this overall backlash result suggests that the approach, delivery mechanisms, and specifics of these organizations' materials are in need of a serious rethink.



### self-report measures are not systematically different

Based on past research[@mathur2021effectiveness], we expected to see evidence of self-report bias manifesting as larger results for self-reported outcomes than for obliquely measured results. However, we find the opposite: 
