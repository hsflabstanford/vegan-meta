...
### Descriptive overview of meta-analytic database
...
### The leading theoretical approaches to reducing MAP consumption 
...
In the MAP reduction literature broadly, there are many, many theoretical perspectives and approaches. In the policy-relevant literature, however, interventions fall into three buckets: norms, nudges and persuasion. Persuasion approaches comprise three sub-categories: health, environmental, and animal welfare appeals. 
...
Norms-based approaches inform `r nrow(norms)` of `r num_studies` interventions in our database. These interventions typically try to normalize vegetarianism and veganism by creating a perception that eating plant-based meals is consistent with social norms. To do this, researchers might put up signs that say “[More and more [retail store name] customers are choosing our veggie options" [@coker2022, p. 2] or "In a taste test we did at the [name of cafe], 95% of people said
that the veggie burger tasted good or very good!" [@piester2020, p. 5]. One study told participants that people who eat meat are more likely to endorse social hierarchy and embrace human dominance over nature [@allen2002], thus making them out to be a counter-normative outgroup.

Two theoretical splits characterize this literature. The first is between _descriptive_ norms that  _injunctive_ norms 
- Divide between injunctive and descriptive norms
- Divide between dynamic and static norms. 
- Others arguably embody both approaches, e.g. a reminder about the fact that your peers really like the veggie burger is placed in a non-obtrusive, low-cost way: is it a nudge? We'd argue yes, if it meets the following conditions [@hansen2016]...even when papers don't necessarily describe themselves that way.



(clearly need to rewrite this section and all the ones following)
...
### Nudges
- Note how few studies meet this definition
- it's actually a very large literature (see Bianchi 2018, [Mertens](https://www.pnas.org/doi/10.1073/pnas.2107346118), [Arno](https://bmcpublichealth.biomedcentral.com/articles/10.1186/s12889-016-3272-x), and [Wynes](https://iopscience.iop.org/article/10.1088/1748-9326/aae5d7/meta) for overview. but once we started filtering by dependent variable, those numbers fell a lot; e.g. Mertens looks at just one study that meets our criteria and the rest look at vegetable intake. 
- Another large problem is the preponderance of hypothetical outcomes
- Describe the papers we do include
...
Our meta-analysis of `r num_studies` policy-relevant interventions yields an overall meta-analytic effect of `r `main_result$Delta` (se = `rmain_result$se`), p = `r main_result$p`. Though statistically significant, this effect does not meet the conventional standard for a 'small' result in the behavioral sciences. This stands in marked contrast to previous reviews, which found [PUT IN RESULTS OF PREVIOUS METAS]. This diverge seems to be a product of our inclusion criteria, specifically the requirement that studies measure actual consumption behavior rather than self-reported intentions or hypothetical choices. [say more about this].
