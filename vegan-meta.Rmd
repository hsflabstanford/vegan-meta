...
Our meta-analysis of `r num_studies` policy-relevant interventions yields an overall meta-analytic effect of `r main_result$Delta` (se = `r main_result$se`), p = `r main_result$pval`. This is not clinically or statistically significant. Moreover, `r sign_table[[2]]` of `r num_studies` had, in their own words, no significant findings (`r null_proportion` percent of all studies).
