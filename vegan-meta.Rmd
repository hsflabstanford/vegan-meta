...
hybrid_norm_approaches |> select(author, year, theory)
...
Finally, `r nrow(hybrid_norm_approaches)` deploy norms-based nudges in unobtrusive ways in dining halls [@piester2020, @coker2022], which arguably makes them nudges. For example, @piester2020 combined a descriptive norm message with a nudge: a sign that said "In a taste test we did at the [name of cafe], 95% of people said that the veggie burger tasted good or very good!" [@piester2020, p. 5]. 

The question of whether such approaches are norms is debatable. We follow the guidance of @hansen2016, who argues... even when papers don't necessarily describe themselves that way.
