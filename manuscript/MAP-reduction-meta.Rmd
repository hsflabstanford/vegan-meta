...
n_meat_total <- round_to(x = sum(RPMC$n_c_total_pop) + sum(RPMC$n_t_total_pop), 
                        accuracy = 1000, direction = "down")
```
...
See code and data repository for details on the `r reviews_count` prior reviews we consulted and approximately  papers we excluded.
...
We aimed for complete computational reproducibility [@polanin2020]
