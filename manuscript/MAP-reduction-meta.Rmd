...
-   Question for Maya – what else should go here?
    I'd favor a discussion of meta-analytic models and the fact that our results are a bit sensitive to differences
...
Counting which studies pursue which theories of change requires drawing boundaries around those theories.
...
However, which incentives count as economic is not self-evident; others have noted that many of the examples cited by Thaler and Sunstein actually do alter incentives [@selinger2012].
...
By this definition, an injunctive norm intervention, which implies a threat of social deviance and therefore sanction, does not qualify.
