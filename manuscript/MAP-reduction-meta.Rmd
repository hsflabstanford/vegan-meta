...
There is a vast and diverse literature investigating potential means to reverse this trend. Example approaches include providing free access to meat substitutes [@katare2022], changing the price [@horgen2022] or perceptions [@kunst2016] of meat, or attempting to persuade people to change their diets [@bianchi2018a]. A large portion of this literature seeks to alter the contexts in which MAP is selected [@bianchi2018b], for instance by changing menu layouts [@bacon2018; gravert2019] or placing vegetarian items more prominently in dining halls [@ginn2024]. Some interventions are associated with large impacts [@hansen2019; @boronofsky2022; @reinders2017], and prior reviews have concluded that some frequently studied approaches, such as making vegetarian meals the default [@meier2022] and using persuasive messaging that appeals to animal welfare [@mathur2021meta], may be consistently effective. 
