...
However, it also has few if any agreed upon terms to describe what its studies are pursuing.
For instance,the term "MAP" is not standard; other papers in the same vein talk about animal-based proteins, animal products, meat, edible animal products, plant-based foods, plant-based protein, and so on.
This diversity of language poses a particular challenge for anyone seeking to systematically review this literature.
Whether one has searched for the correct terms that each relevant study uses to describe itself is, for all practical purposes, unknowable.
