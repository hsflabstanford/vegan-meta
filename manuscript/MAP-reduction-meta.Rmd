...
Studies in our database pursued three theories of change: norms, choice architecture, and persuasion, or a combination of norms and persuasion.

**PSYCHOLOGY**studies -- REDO THIS WHOLE SECTION [@aldoh2023; @allen2002; @alblas2023; @coker2022; @griesoph2021; @piester2020; @sparkman2017; @sparkman2020] manipulate the perceived popularity of desired outcomes, e.g. plant-based dishes [@sparkman2017].
...
Finally, a sizable group of interventions combines **persuasion** approaches with other approaches REDO THIS SECTION TO MENTION FREE MEAT ALTERNATIVES AND STUFF [@hennessy2016; @carfora2023; @mattson2020; @piester2020].
