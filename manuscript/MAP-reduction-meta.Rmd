...
Table 1 summarizes studies' basic characteristics in terms of population, decade of publication, where studies were published, and how interventions were delivered. The earliest paper was published in 2002 [@allen2002] and a majority (`r  decade_tab |> filter(decade == "2020s") |> pull(n)` of `r num_papers` papers) have been published since 2020.
