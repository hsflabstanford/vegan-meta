...
Table S2 provides an overview of alternate esimates by our main theoretical approaches.
...
One potential source of measurement error that we cannot easily correct for is the possibility that a subject who is 'nudged' into eating less meat at one meal eats more at the next, i.e. "regression to the meat." Most cafeteria-based studies we looked at were not designed to measure this kind of spillover effect.
We encourage future researchers to collect follow-up data whenever possible.
\newpage
