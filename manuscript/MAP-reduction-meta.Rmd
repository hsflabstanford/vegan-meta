...
Some interventions are associated with large impacts [@hansen2021; @boronowsky2022; @reinders2017], and prior reviews have concluded that some frequently studied approaches, such as making vegetarian meals the default [@meier2022] and using persuasive messaging that appeals to animal welfare [@mathur2021meta], may be consistently effective.  Practitioners are increasingly implementing these ideas in such settings as university dining halls [@pollicino2024] and hospital cafeterias [@morgenstern2024].
