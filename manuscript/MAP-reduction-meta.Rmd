...
We aimed for the highest standards of computational reproducibility [@stodden2018; @polanin2020] using `Rmarkdown` [@xie2018] to create a reproducible document and a containerized [@moreau2023] online platform [@clyburne2019] to ensure push button [@wood2018].
