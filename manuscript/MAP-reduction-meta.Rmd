...
This small effect may surprise readers of previous reviews, which typically found more positive results [@mathur2021meta; @meier2022; @mertens2022].
...
By far the most common reason was the wrong dependent variable (e.g. attitudinal or intentional outcomes).
However, many cases were harder and required some discussion.
Here were a few difficult cases.
...
Other studies induce a form of treatment in their control groups, for instance asked to take a pledge to go vegetarian or encouraged not to change one's diet over the course of study, which could potentially induce changes relative to baseline consumption patterns.
We only analyzed studies where with a pure control group or an unrelated placebo.

Another common design limitation we encountered was treatment assigned at the level of alternating weeks at a cafeteria.
Generally these studies did not have enough weeks to meet our sample size requirements, but we also noted that simply alternating weeks is not random assignment and it is possible that consumption patterns will not be equivalent between treatment and control groups in expectation.

Last, we encountered many studies that measured fruit and or/vegetable consumption but not MAP consumption.
In some cases, it might have been possible to make some strong assumptions about substitution and estimate a MAP effect size, but we decided to focus on studies that reported this information directly.
