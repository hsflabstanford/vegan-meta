...
See supplement for discussion of deviations from pre-registration.
...
Likewise, as our analyses show, including studies aimed at reducing consumption of RPM approximately doubles the overall effect from $\Delta$ = `r overall_results$Delta` to `r merged_results$Delta`.
