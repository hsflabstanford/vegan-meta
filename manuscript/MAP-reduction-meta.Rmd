...
Last, we compiled a third dataset of over 800 excluded studies, along with their reason(s) for exclusion.
...
Fourth, the pooled effect size of interventions published in peer-reviewed journals is about five times larger than the pooled effect size from everything else (advocacy organization publications, preprints, and student theses).
