...
Some interventions are associated with large impacts [@hansen2021; @boronowsky2022; @reinders2017], and prior reviews have concluded that some frequently studied approaches, such as making vegetarian meals the default [@meier2022] and using persuasive messaging that appeals to animal welfare [@mathur2021meta], may be consistently effective. [SENTENCE ABOUT HOW PRACTICIONIERS ARE BEGINNING TO PUT THESE IDEAS INTO PRACTICE -- WRI REPORT]
