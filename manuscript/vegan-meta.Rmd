...
Scholars have approached the problem of MAP reduction from a myriad of academic disciplines, including social psychology [@rosenfeld2018; @dhont2019], economics [@lusk2009], choice architecture [@bianchi2018restructuring; @mertens2022]; and environmental studies [@costello2016]. The central theoretical divide we observe in our database of policy-relevant studies is between **information-based approaches** that attempt to change ideas about MAP consumption and **place-based interventions** that make MAP consumption more difficult, expensive, or apparently counter-normative in a restaurant or university dining hall. Which of these two approaches is more effective at changing real world behavior has broad implications for behavioral scientists and policymakers.  
