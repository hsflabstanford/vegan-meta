...
Second, we located and read 21 previous systematic reviews, starting with @mathur2021effectiveness as well as @bianchi2018restructuring and @bianchi2018conscious. Those three reviews yielded nine additional papers. We then read and categorized papers from 18 additional reviews (assisted greatly by @grundy2022, a review of reviews); From @harguess2020 and

1.  

    1.  Our search for reviews was assisted greatly by posts by [[Peter Slattery]{.underline}](https://forum.effectivealtruism.org/posts/Sy7swEetrtcK2C7q6/research-summary-a-meta-review-of-interventions-that) and [[Emily Grundy]{.underline}](https://forum.effectivealtruism.org/posts/azHZ2pQj9JgdZLC63/what-interventions-influence-animal-product-consumption) summarizing their [[2022 review of reviews]{.underline}](https://www.sciencedirect.com/science/article/pii/S2666833521000976#!).

2.  We searched the homepages, Google Scholar pages, and co-authorship lists of researchers with studies in our database.

3.  Occasionally, articles’ published pages suggested further reading that seemed promising.

4.  Once we had a pretty good list assembled, we emailed [[Maya Mathur]{.underline}](https://www.mayamathur.com/), [[Jacob Peacock]{.underline}](https://www.jacobpeacock.com/), [[Andrew Jalil]{.underline}](https://www.oxy.edu/academics/faculty/andrew-jalil), [[Gregg Sparkman]{.underline}](https://www.bc.edu/bc-web/schools/mcas/departments/psychology/people/faculty-directory/gregg-sparkman.html), [[Joshua Tasoff]{.underline}](https://scholar.cgu.edu/joshua-tasoff/), [[Lucius Caviola]{.underline}](https://luciuscaviola.com/), [[Jacy Reese Anthis]{.underline}](https://jacyanthis.com/), [[Emma Garnett]{.underline}](https://www.phc.ox.ac.uk/team/emma-garnett), [[Daniel Rosenfeld]{.underline}](https://www.daniellrosenfeld.com/) and [[Kristof Dhont]{.underline}](https://www.kent.ac.uk/psychology/people/220/dhont-kristof) to see if we had missed any relevant papers. 
