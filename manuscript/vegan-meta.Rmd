...
initial_reviews <- as.numeric(paper_sources["Bianchi (2018a)"]) + 
  as.numeric(paper_sources["Mathur (2021)"])

second_reviews <- as.numeric(paper_sources["Chang et al. (2023)"]) + 
  as.numeric(paper_sources["Harguess (2019)"]) +  as.numeric(paper_sources["Wynes (2018)"])
```

First, we read all qualifying studies that SAG and BS knew of at the outset, which yielded `r prior_knowledge` papers.

Second, we located and read XX previous systematic reviews, starting with @mathur2021effectiveness as well as @bianchi2018restructuring and @bianchi2018conscious. Those three reviews yielded `r initial_reviews` additional papers. We then read and categorized papers from XX additional reviews (assisted greatly by @grundy2022, a review of reviews); From @harguess2020, @chang2023 and @wynes2018,  we learned of three additional papers.
...
source('./code/functions/count_and_robust.R')
