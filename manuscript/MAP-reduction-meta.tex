...
We also coded a supplementary dataset of 17 papers aimed at reducing,
...
comprising 17 studies, 24 interventions, and approximately 10000
...
\begin{comment}
Using our calculations of effect size and standard error 15 interventions have 95% confidence intervals that do not overlap with zero, 12 of which are positive effects, out of 114 interventions.
\end{comment}
...
\(\Delta\) = 0.257 \text{(SE = 0.061)}, p = .0009. Each of the RPM
...
\(\Delta\) = 0.274 (SE = 0.064), p = .0008. This fits with the broader
