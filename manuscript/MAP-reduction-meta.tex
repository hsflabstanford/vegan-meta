...
\citep{scarborough2023, koneswaran2008, greger2010}, and improving
animal welfare \citep{kuruc2023, scherer2019}. However, MAP is widely
regarded as normal, necessary, and a dietary staple
\citep{piazza2022, milford2021}. Global MAP consumption is increasing
...
meat substitutes \citep{katare2022}, changing the price
\citep{horgen2022} or perceptions \citep{kunst2016} of meat, or
attempting to persuade people to change their diets
\citep{bianchi2018a}. A large portion of this literature seeks to alter
the contexts in which MAP is selected \citep{bianchi2018b}, for instance
by changing menu layouts {[}\citet{bacon2018}; gravert2019{]} or placing
vegetarian items more prominently in dining halls \citep{ginn2024}. Some
interventions are associated with large impacts
\citep{hansen2019, boronofsky2022, reinders2017}, and prior reviews have
concluded that some frequently studied approaches, such as making
vegetarian meals the default \citep{meier2022} and using persuasive
messaging that appeals to animal welfare \citep{mathur2021meta}, may be
consistently effective.

However, much of this literature is beset by design and measurement
limitations. Many well-designed interventions are either not randomized
...
Further, many studies measure only immediate impacts {[}hansen2019;
griesoph2021{]} rather than longer-term effects, or focus on
hypothetical choices \citep{Raghoebar2020, vermeer2010}. Last, numerous
studies specifically aim to reduce consumption of red and processed meat
(RPM). Such interventions may induce people to switch from consuming RPM
to consuming other forms of MAP, such as chicken or fish
\citep{grummon2023}. While RPM is of special concern for health and
greenhouse gas emissions \citep{abete2014, lescinsky2022}, increasing
chicken or fish consumption may lead to substantially worse outcomes for
animal welfare \citep{mathur2022ethical}, and fails to reduce the risk
of zoonotic outbreaks from factory farms \citep{hafez2020} or land and
water pollution \citep{grizinik2023}.
...
\citep{wykes2007, paluck2019, scheel2021}. Does this phenomenon hold in
...
at least ten clusters in total.

In contrast to the hugely diverse MAP reduction literature writ large,
these studies exclusively pursue one of four theoretical approaches:
choice architecture (the manipulation of how MAP is presented to
diners), psychological appeals (typically manipulations of perceived
norms around eating meat), explicit persuasion (centered around animal
welfare, the environment, and/or health), or a combination of
psychological and persuasion messages. Interventions varied in delivery
method, for example, documentary films \citep{mathur2021}, leaflets
\citep{peacock2017}, university lectures \citep{jalil2023}, op-eds
\citep{haile2021}, and changes to menus in cafeterias
\citep{andersson2021} and restaurants \citep{coker2022, sparkman2021}.
...
have suggested
\citep{bianchi2018restrucruting, byerly2018, chang2023, harguess2020, kwasny2022, mathur2021, meier2022, pandey2023},
with some intriguing excepxtions. Thus, contradicting previous reviews
...
comprising 40 separate studies, 108 interventions, and approximately
87000 subjects. (The N for subjects is a broad approximation because
...
paper was published in 2002 \citep{allen2002}, and a majority (18 of 34)
...
environments to reduce MAP consumption. Examples include placing a
...
Our overall meta-analytic effect size is \(\Delta\) = 0.066 (SE =
0.023), p = .0098. The aggregate effect is statistically significant,
...
Per the papers' own calculations and data, 93 of 108 interventions had
...
\begin{comment}
Could put this back in: "Using our calculations of effect size and standard error 14 interventions have 95% confidence intervals that do not overlap with zero, 11 of which are positive effects, out of 108 interventions." But I think it's not necesssarys
\end{comment}
...
Journal Article & 52 & 29 & 80400 & 0.0880** (0.0290)\\
\bottomrule
\multicolumn{5}{l}{\rule{0pt}{1em}* p $<$ 0.05, ** p $<$ 0.01, *** p $<$ 0.001.}\\
\end{tabular}
\end{table}
...
\citep{grummon2023}, {[}+ one more cite{]} but some categories of meat
...
patterns of substitution, these interventions are a net good for
personal health and the environment and a net bad for animal welfare.

\subsection{Psychological interventions work sometimes, but it is not
clear why or when}\label{sec2.4}

The overall effect for psychology interventions is \(\Delta\) = 0.108
(SE = 0.047), p = .0919. Of these 29 interventions, 23 are self-reported
...
architecture model, we get a pooled effect size of \(\Delta\) = 0.265
(SE = 0.03), p = .0549, gleaned from 8 interventions with approximately
12400 subjects.
...
between studies are confounded. For example, 17 of 18 interventions with
...
outcomes were not meaningfully different: 0.093 for objectively reported
...
In-Cafeteria & 13 & 8 & 66800 & 0.1010 (0.0380)\\
...
\midrule
North America & 69 & 21 & 40400 & 0.0420 (0.0230)\\
Europe & 28 & 14 & 36300 & 0.1400* (0.0570)\\
...
population (\(\Delta\) = 0.065, SE = 0.04, p = .1386).
...
effect size of 0.027 (SE = 0.012), p = .0217. In relative terms, this is
...
Psychology & 12 & 9 & 51600 & 0.0730* (0.0360)\\
\bottomrule
\multicolumn{5}{l}{\rule{0pt}{1em}* p $<$ 0.05, ** p $<$ 0.01, *** p $<$ 0.001.}\\
\end{tabular}
\end{table}
...
yields an overall effect size of \(\Delta\) = 0.209 (SE = 0.06), p =
.0013. We would have considered this moderate evidence of these
