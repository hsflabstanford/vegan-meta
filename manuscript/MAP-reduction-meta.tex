...
is \(\Delta\) = 0.027 (95\% CI: {[}pub\_ci\_lower, 0.11{]}), p = 0.292).
As assessment of worst case publication bias that analyzes only null
results \citep{mathur2024} yields an estimate of \(\Delta\) = 0.019
(95\% CI: {[}-0.01, 0.049{]}), p = .1694.
...
\subsection{Search}\label{sec3.1}

\subsection{Coding}\label{sec3.2}
