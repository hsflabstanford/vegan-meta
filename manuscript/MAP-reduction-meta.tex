...
\hspace{1em}\cellcolor{gray!10}{Young people} & \cellcolor{gray!10}{3}\\
\hspace{1em}All ages & 2\\
\addlinespace[0.5em]
\multicolumn{2}{l}{\textbf{Publication Decade}}\\
\hspace{1em}\cellcolor{gray!10}{2000s} & \cellcolor{gray!10}{6}\\
\hspace{1em}2010s & 11\\
\hspace{1em}\cellcolor{gray!10}{2020s} & \cellcolor{gray!10}{23}\\
\addlinespace[0.5em]
\multicolumn{2}{l}{\textbf{Publication Status}}\\
\hspace{1em}Journal article & 29\\
\hspace{1em}\cellcolor{gray!10}{Advocacy Organization} & \cellcolor{gray!10}{5}\\
\hspace{1em}Thesis & 5\\
\hspace{1em}\cellcolor{gray!10}{Preprint} & \cellcolor{gray!10}{1}\\
\addlinespace[0.5em]
\multicolumn{2}{l}{\textbf{Delivery Methods}}\\
\hspace{1em}Printed materials & 14\\
\hspace{1em}\cellcolor{gray!10}{Video} & \cellcolor{gray!10}{10}\\
