...
We also coded four supplementary datasets. First is a collection of 16
papers
...
meat (RPM), comprising 16 studies, 24 interventions, and approximately
10000 subjects.
...
\(\Delta\) = 0.254 \text{(SE = 0.064)}, p = .0016. Each of the RPM
reduction studies employs persuasion, and a majority (18 of 24) appeal
...
Health appeals are a component of 18 of 24 interventions aimed at
reducing RPM consumption, and are generally more effective there:
\(\Delta\) = 0.265 (SE = 0.066), p = .0016. This fits with the broader
...
to describe what its studies are pursuing. For instance,the term ``MAP''
is not standard; other papers in the same vein talk about animal-based
proteins, animal products, meat, edible animal products, plant-based
foods, plant-based protein, and so on. This diversity of language poses
a particular challenge for anyone seeking to systematically review this
literature. Whether one has searched for the correct terms that each
relevant study uses to describe itself is, for all practical purposes,
unknowable.
