...
from SMD = 0.07 to 0.13. However, because these studies do not measure
patterns of substitution to other kinds of MAP, we cannot extrapolate
from their recorded effects to an estimate of net MAP reduction.
