...
majority (18 of 34 papers) have been published since 2020. Among studies
...
target. Across 17 studies and 25 point estimates, we detect a pooled
effect of \(\Delta\) = 0.249 (95\% CI: {[}{[}0.113, 0.385{]}{]}, p =
0.0016, \(\rho\) = 0.8. We estimate that 52\% of true effects are above
\(\Delta\) = 0.2.

\subsection{Moderators analysis}\label{moderators-analysis}
...
populations. Nevertheless we explore potential moderators in terms of of
potential moderators of effect size. Table 2 displays effect sizes for
differences by population, region, era of publication, publication
venue, delivery method, and outcome recording strategy.
