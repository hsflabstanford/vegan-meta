...
One of our most unexpected results was how few choice architecture
studies met our inclusion criteria. However, we attribute this in part
to our comparatively strict definition of choice architecture studies as
manipulations to the environment in which choices were made that attempt
to operate on unconscious processes. However, some studies in our
database do not modify aspects of the environment but identify their own
interventions as nudges, meeting the somewhat looser definition of a
nudge as something that's 'cheap and easy to avoid \citep{thaler2008}. I
