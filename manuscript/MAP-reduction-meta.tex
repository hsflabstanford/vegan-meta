...
of rigorous Randomized Controlled Trials (RCTs). We meta-analyze 35
papers comprising 39 studies,107 interventions, and approximately 87000
subjects. We find that these papers employ nudge, norms, or persuasion
approaches to changing behavior. The pooled effect of these
interventions on MAP consumption outcomes is \(\Delta\) = 0.06,
...
comprising 41 separate studies, 112 interventions, and approximately
...
2002 \citep{allen2002}, and a majority (20 of 35) have been published
since 2020.
...
Our overall meta-analytic effect size is \(\Delta\) = 0.06 (SE = 0.022),
p = .0114. The aggregate effect is statistically significant, but does
not indicate a meaningful reduction.
...
\midrule
\textbf{Overall} & 41 & 112 & 88200 & 0.0600* (0.0220)\\
Norms & 11 & 18 & 53100 & 0.0640 (0.0320)\\
Nudge & 2 & 3 & 12200 & 0.2120 (0.0950)\\
Persuasion & 29 & 86 & 22400 & 0.0690* (0.0270)\\
...
\midrule
Health & 17 & 28 & 13300 & 0.0890 (0.0420)\\
Environment & 14 & 23 & 8400 & 0.0830 (0.0540)\\
Animal Welfare & 15 & 62 & 15000 & 0.0330 (0.0220)\\
\bottomrule
...
Per the papers' own calculations, 98 of 112 interventions had null
...
\begin{comment}
Using our calculations of effect size and standard error 14 interventions have 95% confidence intervals that do not overlap with zero, 11 of which are positive effects, out of 112 interventions.
\end{comment}
...
\midrule
Advocacy, preprints, and theses & 54 & 10 & 6200 & 0.0150 (0.0500)\\
...
\(\Delta\) = 0.249 \text{(SE = 0.071)}, p = .0045. Each of the RPM
...
\(\Delta\) = 0.089 (SE = 0.042), p = .0604. This is small and not
...
component is \(\Delta\) = 0.083 (SE = 0.054), p = .1518. The strongest
...
component is \(\Delta\) = 0.033 (SE = 0.022), p = .1671. A full 58 of 62
interventions in this category are self-described nulls. Slightly more
than half (31 of 62) lead to increases in MAP consumption, though just
...
between studies are confounded. For example, 22 of 23 interventions with
...
outcomes were not meaningfully different: 0.079 for objectively reported
vs 0.053 for self-reported. Likewise, the difference in effect sizes for
...
Europe & 31 & 15 & 37600 & 0.0980 (0.0480)\\
...
population ( (\(\Delta\) =0.046 (SE = 0.035), p = .2169).
...
effect size of 0.022 (SE = 0.011), p = .0568. In relative terms, this is
...
persuasion & 86 & 29 & 22400 & 0.0150 (0.0130)\\
\bottomrule
\end{tabular}
\end{table}
