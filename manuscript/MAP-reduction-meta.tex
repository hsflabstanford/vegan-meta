...
detect a pooled effect of \(\Delta\) = 0.249 (95\% CI: {[}0.113,
0.385{]}), p = .0016, \(\tau\) = 0.201. We estimate that 52\% of true
effects are above \(\Delta\) = 0.2.

Meta-analyzing the MAP and RPM studies combined yields an overall
\(\Delta\) of 0.129 (95\% CI: {[}0.069, 0.188{]}), p = .0001, \(\tau\) =
0.138.
...
non-randomized design. Our exclusion of
