...
\includegraphics{results/forest_plot-1}
...
developed for previous papers \citep{paluck2019, paluck2021, porat2024}.
...
\includegraphics{results/supplementary_figure-1}

\subsection{Supplementary Discussion}\label{supplementary-discussion}

\subsubsection{When is a norm a nudge?}\label{when-is-a-norm-a-nudge}
...
\subsection{Supplementary Equation(s)}\label{supplementary-equations}

\subsection{Supplementary Notes (including notes clarifying statistical
analyses, acknowledgements, grant or other
numbers)}\label{supplementary-notes-including-notes-clarifying-statistical-analyses-acknowledgements-grant-or-other-numbers}
