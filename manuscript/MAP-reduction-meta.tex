...
\hspace{1em}Red and processed meat & 17 & 25 & 0.25 & {}[0.11, 0.38] & .002 & .0380\\
\addlinespace[0.3em]
...
main model produce very small estimates. (Although \texttt{metafor} also
...
animal products, plant-based foods, plant-based protein, animal meat and
products, and so on. This diversity of language poses a particular
challenge for anyone seeking to systematically review this literature.
Whether one has identified the correct terms that each relevant study
uses to describe itself is, for all practical purposes, unknowable.
