...
We aimed for the highest standards of computational reproducibility
\citep{stodden2018, polanin2020} using \texttt{Rmarkdown}
\citep{xie2018} to create a reproducible document and a containerized
\citep{moreau2023} online platform \citep{clyburne2019} to ensure push
button \citep{wood2018}.
