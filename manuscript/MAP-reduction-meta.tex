...
0.066 (95\% CI: {[}0.018, 0.114{]}), p = .0094, \(\tau^2\) = 0.006. We
...
{[}0.113, 0.385{]}), p = .0016, \(\tau^2\) = 0.04. We estimate that 52\%
...
\hspace{1em}Pre-analysis plan and/or open data & 0 & 0 & NA & NA & NA & NA\\
\bottomrule
