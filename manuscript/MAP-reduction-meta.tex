...
interventions on MAP consumption outcomes is \(\Delta\) = 0.058,
...
\begin{comment}
Using our calculations of effect size and standard error 13 interventions have 95% confidence intervals that do not overlap with zero, 10 of which are positive effects, out of 108 interventions.
\end{comment}
